 ...
 * W0 ships the seam and no native; W1 adds fs / s3 / url, W2 mcp. An
 * empty registry is a valid boot: every connection then fails its sync
...
@Module({
  ...
  providers: [
    { provide: SOURCE_CONNECTORS, useValue: [] as Connector[] },
