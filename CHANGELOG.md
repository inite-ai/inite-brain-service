...
* **admin:** provision HNSW indexes for every tenant, and record which ones have them ([#512](https://github.com/inite-ai/inite-brain-service/issues/512)) ([881d9de](https://github.com/inite-ai/inite-brain-service/commit/881d9debfcd61a2fa2cb4033ee3c3e3335852e13))
* **ai:** every chat call runs on the current-generation cost tier, through the one reasoning guard ([#617](https://github.com/inite-ai/inite-brain-service/issues/617)) ([0434315](https://github.com/inite-ai/inite-brain-service/commit/0434315d07b358a9d1448f433f3991da89490bc5))
* **ai:** the engine moves to gpt-6-luna, the audit stays behind — and a decision plane for the calls that decide ([#659](https://github.com/inite-ai/inite-brain-service/issues/659)) ([b118eec](https://github.com/inite-ai/inite-brain-service/commit/b118eecf1f8054a1a8149b5e384d07e0ea055e3c))
* **batch:** one terminal status for batch operations, failed keys, retry-only-failed ([#551](https://github.com/inite-ai/inite-brain-service/issues/551)) ([3acec3b](https://github.com/inite-ai/inite-brain-service/commit/3acec3b7a6fe2c6179edca33f0084184158be334))
* **config:** finished surfaces stop shipping switched off ([#582](https://github.com/inite-ai/inite-brain-service/issues/582)) ([509bd3f](https://github.com/inite-ai/inite-brain-service/commit/509bd3fe54a4746a4b838466cad3f0b18a0845a1))
* **conveyor:** declare the assembled conveyor in code, and let an MCP client talk before it has a key ([#603](https://github.com/inite-ai/inite-brain-service/issues/603)) ([8e7c225](https://github.com/inite-ai/inite-brain-service/commit/8e7c225f5c4872375f7edac745ade410783cb63d))
* **deploy:** run the service as N replicas, and make one run at a time own the deploy transaction ([#559](https://github.com/inite-ai/inite-brain-service/issues/559)) ([95a2861](https://github.com/inite-ai/inite-brain-service/commit/95a28615d703a822dcbe241c8356848ee6544ada))
* **distribution:** install brain anywhere, and make memory happen without asking the model ([#570](https://github.com/inite-ai/inite-brain-service/issues/570)) ([1764b2a](https://github.com/inite-ai/inite-brain-service/commit/1764b2aa31c88d86071f55aed4e4c06894ab4ec9))
* **eval:** eval:evidence — mechanical battery over the evidence plane ([#499](https://github.com/inite-ai/inite-brain-service/issues/499)) ([8d78586](https://github.com/inite-ai/inite-brain-service/commit/8d78586cc129fd335456d25769fbdbd344fd2e0e))
* **evidence:** blob upload surface with scan and broker dispatch ([#471](https://github.com/inite-ai/inite-brain-service/issues/471)) ([22d70fe](https://github.com/inite-ai/inite-brain-service/commit/22d70fe9e8d97459f07a47d9f3b976f20f59b9e8))
* **evidence:** bridge a document asset's extracted text into the document pipeline ([#606](https://github.com/inite-ai/inite-brain-service/issues/606)) ([f0cc6ce](https://github.com/inite-ai/inite-brain-service/commit/f0cc6cee3e6359370f17c1638d72a7519384064a))
* **evidence:** fragment-bearing processor outputs + representation embeddings ([#468](https://github.com/inite-ai/inite-brain-service/issues/468)) ([94eee29](https://github.com/inite-ai/inite-brain-service/commit/94eee293996e6f064a24e102520bb1b9bd47b6cb))
* **evidence:** give evidence blobs a shared object store, so a read does not depend on which replica took the upload ([#555](https://github.com/inite-ai/inite-brain-service/issues/555)) ([fa65537](https://github.com/inite-ai/inite-brain-service/commit/fa655371e8a68afa68e2a035d57f337dc867cad7))
* **evidence:** grant and revoke HTTP surface ([#479](https://github.com/inite-ai/inite-brain-service/issues/479)) ([7004fc8](https://github.com/inite-ai/inite-brain-service/commit/7004fc8b91f40364c8ce08445c86e9f521ddc78f))
* **evidence:** local OCR adapter — images become readable memory ([#482](https://github.com/inite-ai/inite-brain-service/issues/482)) ([fc0dcc7](https://github.com/inite-ai/inite-brain-service/commit/fc0dcc72443362d25b2cadab9dcff6569c4f1097))
* **evidence:** orphan blob garbage collection ([#481](https://github.com/inite-ai/inite-brain-service/issues/481)) ([a803c44](https://github.com/inite-ai/inite-brain-service/commit/a803c44737a8b05299e5372560fc16bcb39a3313))
* **evidence:** real image-metadata and document-text processor adapters ([#476](https://github.com/inite-ai/inite-brain-service/issues/476)) ([71b6698](https://github.com/inite-ai/inite-brain-service/commit/71b6698f210d298f666cfa8f85080d70d5e2ae48))
* **extraction:** the extractor reads the memory — pins known entities, closes replaced facts, resolves dates; relations citable; revision round on partial verdicts ([#630](https://github.com/inite-ai/inite-brain-service/issues/630)) ([cc7770f](https://github.com/inite-ai/inite-brain-service/commit/cc7770fd816f73814dcdc73b1b5180d6b93a0470))
* **extractor:** three self-consistency samples per extraction by default — the write is the one stochastic step never re-run ([#651](https://github.com/inite-ai/inite-brain-service/issues/651)) ([ec84601](https://github.com/inite-ai/inite-brain-service/commit/ec84601ed4f68c7d105111f002b57f33445a60bb))
* **identity:** the user's name is memory, not a claim — it follows the name fact; the asker's own lines are headed "you"; the memory says when it has no name yet ([#643](https://github.com/inite-ai/inite-brain-service/issues/643)) ([aefaf32](https://github.com/inite-ai/inite-brain-service/commit/aefaf32326089cb2e7f27afafc6b78a13ee791a9))
* **indexers:** operator view of installed indexers and run health ([#495](https://github.com/inite-ai/inite-brain-service/issues/495)) ([b85705e](https://github.com/inite-ai/inite-brain-service/commit/b85705e9be0eefb79d109172cbe92d27e2732463))
* **indexers:** reference code-repository indexer for the code_memory pack ([#496](https://github.com/inite-ai/inite-brain-service/issues/496)) ([f1a63a3](https://github.com/inite-ai/inite-brain-service/commit/f1a63a32220e1643a1d74aa91c7ca783329fb779))
* **indexers:** source-version stamps and drift-based staleness for derivable facts ([#497](https://github.com/inite-ai/inite-brain-service/issues/497)) ([41171b6](https://github.com/inite-ai/inite-brain-service/commit/41171b6df08b7f3b6e8a9aba6d0d9fbbcd49bed3))
* **ingest:** make the first write two lines, and stop the ingest docs describing an API that does not exist ([#571](https://github.com/inite-ai/inite-brain-service/issues/571)) ([55a281b](https://github.com/inite-ai/inite-brain-service/commit/55a281b76208838f79441cb96142c0bd8f612b99))
* **install:** one click where one click exists, one command where it does not ([#579](https://github.com/inite-ai/inite-brain-service/issues/579)) ([d2ea697](https://github.com/inite-ai/inite-brain-service/commit/d2ea6972e4cdc4f1b7801e6e25e85cb71eef66cb))
* **landing:** explain architecture, Domain Packs and agent onboarding ([#467](https://github.com/inite-ai/inite-brain-service/issues/467)) ([1961e9a](https://github.com/inite-ai/inite-brain-service/commit/1961e9a7b0b3a51cb090733ec3800b9a6da88c43))
* **landing:** say what is broken, whose the memory is, and what is plainly true ([#581](https://github.com/inite-ai/inite-brain-service/issues/581)) ([f975bc2](https://github.com/inite-ai/inite-brain-service/commit/f975bc2b01191e46d9ee38a14e55c986ccdb0657))
* **mcp:** a ChatGPT connector facade, and the deep link that makes its citations real ([#574](https://github.com/inite-ai/inite-brain-service/issues/574)) ([4cc07c2](https://github.com/inite-ai/inite-brain-service/commit/4cc07c2998c83122f11679086553881ac4eecbc5))
* **mcp:** tool profiles, and stop paying 200 tokens per datetime argument ([#572](https://github.com/inite-ai/inite-brain-service/issues/572)) ([7319dbe](https://github.com/inite-ai/inite-brain-service/commit/7319dbedf973a95059d29c68960b4805e3cdea32))
* **memory-files:** back Anthropic's memory tool with brain instead of a directory ([#573](https://github.com/inite-ai/inite-brain-service/issues/573)) ([9ba7875](https://github.com/inite-ai/inite-brain-service/commit/9ba78751624d63fd38a5e007ec1f1ea3a7e35d20))
* **monitoring:** capability probes — an active signal for the capability that dies while /health stays green ([#511](https://github.com/inite-ai/inite-brain-service/issues/511)) ([b5d93f5](https://github.com/inite-ai/inite-brain-service/commit/b5d93f5a1c5dc62a69b20364be2675fc17bb27a1))
* **multilingual:** Tier 0 live — script-independent names, ICU dates, evidence for the judge, relations as evidence ([#604](https://github.com/inite-ai/inite-brain-service/issues/604)) ([3bd37cc](https://github.com/inite-ai/inite-brain-service/commit/3bd37ccc18eb39a98baab40163ad7912bec646b9))
* **outcomes:** give the decision stream a reader, and switch capture on ([#586](https://github.com/inite-ai/inite-brain-service/issues/586)) ([3d8d206](https://github.com/inite-ai/inite-brain-service/commit/3d8d2069de30d28fd958b27c4847fd75a6e46fad))
* **packs:** capture-path producer for pack memory projections ([#469](https://github.com/inite-ai/inite-brain-service/issues/469)) ([6740c06](https://github.com/inite-ai/inite-brain-service/commit/6740c060f691e1a7db67b7b74273ad8abd93112b))
* **packs:** media contracts — modalities, processors and raw-evidence policy for all packs ([#470](https://github.com/inite-ai/inite-brain-service/issues/470)) ([8db3746](https://github.com/inite-ai/inite-brain-service/commit/8db374650c4531728bfba09328f4f2c12e19c7cf))
* **packs:** pack-projected state deltas reach belief promotion ([#472](https://github.com/inite-ai/inite-brain-service/issues/472)) ([cff093a](https://github.com/inite-ai/inite-brain-service/commit/cff093a934800cff420758d5a8a0a3f4f5651b00))
* **registry:** classify a coined predicate's cardinality instead of assuming append_only ([#592](https://github.com/inite-ai/inite-brain-service/issues/592)) ([09dfab2](https://github.com/inite-ai/inite-brain-service/commit/09dfab2312a957ab604a0dc1e8981752e5db338c))
* **scenes:** gist embeddings and resolved entity links ([#480](https://github.com/inite-ai/inite-brain-service/issues/480)) ([5ae89ef](https://github.com/inite-ai/inite-brain-service/commit/5ae89ef3ef5868a268667e8b7b63cfb398811e8a))
* **scenes:** memory-value promotion gate and namespaced baselineRef ([#478](https://github.com/inite-ai/inite-brain-service/issues/478)) ([37a34c5](https://github.com/inite-ai/inite-brain-service/commit/37a34c5ab33385efe682544b76e17847c94046ec))
* **scenes:** prediction baseline — measured surprise instead of guessed saliency ([#473](https://github.com/inite-ai/inite-brain-service/issues/473)) ([747ab9b](https://github.com/inite-ai/inite-brain-service/commit/747ab9b8d1976f05a18fc4126d164f251f5f0dbb))
* **scenes:** scene serving lane — the first read consumer of the episodic plane ([#475](https://github.com/inite-ai/inite-brain-service/issues/475)) ([c3c92b8](https://github.com/inite-ai/inite-brain-service/commit/c3c92b8f5b925bc3e78faa98068c3cfc4f1e4bc3))
* **scenes:** scheduled maintenance, dirty-conversation trigger and scene metrics ([#474](https://github.com/inite-ai/inite-brain-service/issues/474)) ([15b3009](https://github.com/inite-ai/inite-brain-service/commit/15b3009fedf760f4b25558bd2b50daeec7fb0558))
* **scenes:** the episodic plane gets a reader — a scene read API, a Memory page, and a pass that runs while the user is still there ([#618](https://github.com/inite-ai/inite-brain-service/issues/618)) ([b6e9712](https://github.com/inite-ai/inite-brain-service/commit/b6e97128d7f1269ed3273ea9d5dbf857f65f3d43))
* **sdk:** @inite/brain — a typed client, framework tools, and a LangGraph-shaped store ([#576](https://github.com/inite-ai/inite-brain-service/issues/576)) ([3162343](https://github.com/inite-ai/inite-brain-service/commit/3162343a25aafbe2e741fbe73fad5c2554ba869a))
* self-serve keys, tenant-less /mcp, and the onboarding tools that follow a connection ([#568](https://github.com/inite-ai/inite-brain-service/issues/568)) ([45bef1e](https://github.com/inite-ai/inite-brain-service/commit/45bef1e6df03698a82e50a68937439a697bec308))
* **source-plane:** sources become memory — files, web, MCP, the local agent, CRM records, cloud drives, wikis, mail, chat and the forge (W0–W4.8) ([#658](https://github.com/inite-ai/inite-brain-service/issues/658)) ([f46e038](https://github.com/inite-ai/inite-brain-service/commit/f46e038fa424e468075d845142bf4c5a4699e7f8))


### Bug Fixes

* **admin:** anchor an SSE stream's cursor where the subscription began ([#567](https://github.com/inite-ai/inite-brain-service/issues/567)) ([a6f7cba](https://github.com/inite-ai/inite-brain-service/commit/a6f7cba3bf5ecbefd64cb627f6a1b9ce6cdc38de))
* **admin:** build HNSW indexes CONCURRENTLY, and stop assuming an index that exists is an index that works ([#507](https://github.com/inite-ai/inite-brain-service/issues/507)) ([e6edc1b](https://github.com/inite-ai/inite-brain-service/commit/e6edc1bc3e765d6d6ff351cb6235638ca06b486a))
* **admin:** mask EVIDENCE_SIGNED_URL_SECRET in the config inspector ([#500](https://github.com/inite-ai/inite-brain-service/issues/500)) ([2b8a40a](https://github.com/inite-ai/inite-brain-service/commit/2b8a40a3f27fafad49684ccc24d892e35c4bf7f6))
* **ai:** route every transformers load site at the container model cache ([#563](https://github.com/inite-ai/inite-brain-service/issues/563)) ([1d0ce59](https://github.com/inite-ai/inite-brain-service/commit/1d0ce59efa55f4bc0212a17cf36dd0cf9bd0f115))
* **answer-cache:** an answer the belief plane alone supports may be cached ([#660](https://github.com/inite-ai/inite-brain-service/issues/660)) ([ed81374](https://github.com/inite-ai/inite-brain-service/commit/ed81374201240276cda11941b5b01580333c653e))
* **answer-cache:** cache every dependency of an answer, and count usage only for what was served ([#536](https://github.com/inite-ai/inite-brain-service/issues/536)) ([abd5b2b](https://github.com/inite-ai/inite-brain-service/commit/abd5b2b7156a187bc4f2cbc07be3442d694fbdaf))
* **answer-cache:** re-fence every dependency on a cached serve, and stamp it from retrieval ([#564](https://github.com/inite-ai/inite-brain-service/issues/564)) ([83695a2](https://github.com/inite-ai/inite-brain-service/commit/83695a2e362b631fd6de6991fbba1ca1d44277c8))
* **auth,policy:** share the security state that N replicas must agree on ([#552](https://github.com/inite-ai/inite-brain-service/issues/552)) ([89875c9](https://github.com/inite-ai/inite-brain-service/commit/89875c9b49797f03a503363a8820edb9e5dfd101))
* **auth:** background fan-outs walk one roster — registry-active tenants, never the static union ([#548](https://github.com/inite-ai/inite-brain-service/issues/548)) ([00f5bae](https://github.com/inite-ai/inite-brain-service/commit/00f5bae55992fbc0c00bb6f92e7d09122a473c6a))
* **beliefs:** retry the scene consolidation stamp when the store reports a conflict ([#561](https://github.com/inite-ai/inite-brain-service/issues/561)) ([9ad2dc0](https://github.com/inite-ai/inite-brain-service/commit/9ad2dc01d420e6efb0c25d8389115d1fc1897534))
* **beliefs:** two clocks per revision, a full-chain fold on targeted runs, and a compare-and-set revision write ([#537](https://github.com/inite-ai/inite-brain-service/issues/537)) ([877152d](https://github.com/inite-ai/inite-brain-service/commit/877152ddf00d4cb3ed065f16bcef25cefb2a8cac))
* **ci:** key concurrency on the PR, so push and pull_request stop racing ([#529](https://github.com/inite-ai/inite-brain-service/issues/529)) ([0a151de](https://github.com/inite-ai/inite-brain-service/commit/0a151dec2f0efb0154e3117ba80ea0509cefe043))
* **ci:** let an overtaken deploy stand down instead of failing ([#565](https://github.com/inite-ai/inite-brain-service/issues/565)) ([5db0aea](https://github.com/inite-ai/inite-brain-service/commit/5db0aeacfe06e11d68e8cbdd4dbfa3cf9b5af91f))
* **ci:** read the deploy step's context from env so the workflow file is valid again ([#531](https://github.com/inite-ai/inite-brain-service/issues/531)) ([ed78304](https://github.com/inite-ai/inite-brain-service/commit/ed78304396c9fbde1c7e6cede53703893f625176))
* **ci:** the pinned MinIO image vanished from Docker Hub ([#585](https://github.com/inite-ai/inite-brain-service/issues/585)) ([bfc9064](https://github.com/inite-ai/inite-brain-service/commit/bfc9064a9f0780f881d1631d44143b73197ede82))
* **compaction:** a promotion summary keeps the validity of the memory it replaces, and lands with the compaction in one transaction ([#532](https://github.com/inite-ai/inite-brain-service/issues/532)) ([58842da](https://github.com/inite-ai/inite-brain-service/commit/58842dafee823a0f3ff467663e0587000a2c1a3b))
* **compaction:** keep the recompose changefeed cursor bigint so the nightly job stops failing on 3.x ([#530](https://github.com/inite-ai/inite-brain-service/issues/530)) ([f3a9f52](https://github.com/inite-ai/inite-brain-service/commit/f3a9f526a56309b8dc34c61f3299e98941633847))
* **config:** the catalogue told operators the strict-space guard was off ([#583](https://github.com/inite-ai/inite-brain-service/issues/583)) ([a0273ac](https://github.com/inite-ai/inite-brain-service/commit/a0273acf31cddc5860ce580011366b47fbf143cd))
* **conveyor:** the path a deployment ships had no episode, no event time and no persisted trace — found by walking the whole chain with the trace open ([#605](https://github.com/inite-ai/inite-brain-service/issues/605)) ([9061504](https://github.com/inite-ai/inite-brain-service/commit/9061504269f9488c4209632d49aba0b92256a3fb))
* **db:** arbitrate schema migration across replicas and land each file atomically ([#556](https://github.com/inite-ai/inite-brain-service/issues/556)) ([a1f3345](https://github.com/inite-ai/inite-brain-service/commit/a1f334595cf6cd208df0d77a48186ee1f22f42ae))
* **db:** keep schema provisioning off the connection pool and off the lease ([#566](https://github.com/inite-ai/inite-brain-service/issues/566)) ([021c34f](https://github.com/inite-ai/inite-brain-service/commit/021c34facdbb59d2746978e547e86246cc0a50ea))
* **db:** one session discipline for both pools, LIVE channels and the scoped fail-closed path ([#521](https://github.com/inite-ai/inite-brain-service/issues/521)) ([67e883e](https://github.com/inite-ai/inite-brain-service/commit/67e883e69ea94f983ad4ddf9dd8a34645515885b))
* **db:** reconcile FLEXIBLE on every declared field, derived from the migrations rather than retyped ([#526](https://github.com/inite-ai/inite-brain-service/issues/526)) ([2703efb](https://github.com/inite-ai/inite-brain-service/commit/2703efb79902f2dc15de49e40a62019802e0dda0))
* **db:** renew scoped-pool sessions before the driver invalidates them ([#502](https://github.com/inite-ai/inite-brain-service/issues/502)) ([2948e3a](https://github.com/inite-ai/inite-brain-service/commit/2948e3a7743f1df1e522b84126ab0d612192a4fd))
* **deps:** move the multer and js-yaml overrides onto their patched versions ([#514](https://github.com/inite-ai/inite-brain-service/issues/514)) ([fb1eae1](https://github.com/inite-ai/inite-brain-service/commit/fb1eae1d688b11cc55d3e6c40943b3e4ce9af892))
* **documents:** every document writer declares its origin, and the async path keeps the tool-observation hop ([#534](https://github.com/inite-ai/inite-brain-service/issues/534)) ([d2cbd2e](https://github.com/inite-ai/inite-brain-service/commit/d2cbd2e4d62c8b6fbe3a076490e75e4cd49376ab))
* **documents:** SOURCE_META_STRICT polices the caller channel, not brain's own provenance ([#510](https://github.com/inite-ai/inite-brain-service/issues/510)) ([f6053de](https://github.com/inite-ai/inite-brain-service/commit/f6053de0e2f04b2d05b26cca3dc320124ee8079d))
* **embedder:** fail closed on cross-space vector writes, and make the width mismatch unrepresentable ([#503](https://github.com/inite-ai/inite-brain-service/issues/503)) ([0cd331c](https://github.com/inite-ai/inite-brain-service/commit/0cd331ce586ad9d3f9bc43518e2c2000de0562e2))
* **embedder:** retry a failed warmup, and let hybrid search degrade instead of 503 ([#518](https://github.com/inite-ai/inite-brain-service/issues/518)) ([c326532](https://github.com/inite-ai/inite-brain-service/commit/c3265327391dfca27683b29601e53778b901ac27))
* **entities:** identity is tenant-wide, scope is on the fact — legacy per-user copies folded back; timeline carries validFrom; the revision round no longer waits for the auditor's coverage vote ([#650](https://github.com/inite-ai/inite-brain-service/issues/650)) ([677c945](https://github.com/inite-ai/inite-brain-service/commit/677c945ecfba395a415e5b81461c26a60e3e6ae5))
* **evidence:** only an ACTIVE pack install consents to raw-evidence reads ([#528](https://github.com/inite-ai/inite-brain-service/issues/528)) ([a4fbf84](https://github.com/inite-ai/inite-brain-service/commit/a4fbf849a1768526212109ef482d195692ff7025))
* **extraction:** the next turn sees what the last turns of its conversation were filed under ([#631](https://github.com/inite-ai/inite-brain-service/issues/631)) ([a2e78f3](https://github.com/inite-ai/inite-brain-service/commit/a2e78f3d21b55dcd967a6d7379f23162fe7f5ed4))
* **extractor:** local NER merges wordpieces and CJK runs into spans — the pipeline never did ([#616](https://github.com/inite-ai/inite-brain-service/issues/616)) ([1ddfca2](https://github.com/inite-ai/inite-brain-service/commit/1ddfca218aec0ab768927ff9d29ecd21c481c40a))
* **extractor:** production ran the closed CRM vocabulary — the open profile ships; a directly recorded fact is servable; Russian clauses, multilingual instruction triggers, trace eviction ([#627](https://github.com/inite-ai/inite-brain-service/issues/627)) ([f49a1d4](https://github.com/inite-ai/inite-brain-service/commit/f49a1d4a16b0fe07431d401fc5b27b10226dbd5c))
* **feedback,auth:** one rollup delta per standing vote, and suspension that survives activity ([#533](https://github.com/inite-ai/inite-brain-service/issues/533)) ([13623df](https://github.com/inite-ai/inite-brain-service/commit/13623df0b701e8346d40250df3c277892ebe7a62))
* **feedback:** a vote must pass the fact's visibility fence, not just an existence check ([#527](https://github.com/inite-ai/inite-brain-service/issues/527)) ([37d6a24](https://github.com/inite-ai/inite-brain-service/commit/37d6a24f1e3ff53c601eda21c039fbacb1f825cb))
* **fovea:** close the lens-suppression centroid bypass — width and space checked at the write ([#508](https://github.com/inite-ai/inite-brain-service/issues/508)) ([b2fca9b](https://github.com/inite-ai/inite-brain-service/commit/b2fca9ba64a7d3c423cc0aee6b39c09933770569))
* **health:** exempt the probes from rate limiting, so a busy service stays in rotation ([#569](https://github.com/inite-ai/inite-brain-service/issues/569)) ([f36fab4](https://github.com/inite-ai/inite-brain-service/commit/f36fab4e64cef3ca1b3fbe56d6c48383b1b16a50))
* **health:** one readiness vocabulary for /ready, the admin grid and the capability probe ([#539](https://github.com/inite-ai/inite-brain-service/issues/539)) ([b3fe7a5](https://github.com/inite-ai/inite-brain-service/commit/b3fe7a5ac408cd540f1e2a513299d48be8c88309))
* **http:** believe the proxy, so anonymous callers stop sharing one rate-limit bucket ([#575](https://github.com/inite-ai/inite-brain-service/issues/575)) ([dd836c5](https://github.com/inite-ai/inite-brain-service/commit/dd836c59d9d50446cafa83d3779903eea85a8f0b))
* **ingest,search:** an edge is as personal as the facts of its turn — user-scoped turns stamp userId on edges, uniqueness is per scope, every relation read is fenced ([#647](https://github.com/inite-ai/inite-brain-service/issues/647)) ([2a9299a](https://github.com/inite-ai/inite-brain-service/commit/2a9299adac3db15efa043259eb81caf0e8feb6d4))
* **ingest,synthesize:** the user is an entity of their own memory — the userId is the speaker, first-person turns land on the user's own entity, and the answer plane knows who is asking ([#640](https://github.com/inite-ai/inite-brain-service/issues/640)) ([44ae835](https://github.com/inite-ai/inite-brain-service/commit/44ae8351e9b7147ef03de8840725937ef09afffb))
* **ingest:** a first name after the full name resolves to the same person — the judge gets the part as its reason ([#622](https://github.com/inite-ai/inite-brain-service/issues/622)) ([166ce3f](https://github.com/inite-ai/inite-brain-service/commit/166ce3fbea40cc2cd3537d79d693648886cb5109))
* **ingest:** a structured entityRef must not mint a name the graph already knows ([#593](https://github.com/inite-ai/inite-brain-service/issues/593)) ([95ec9a4](https://github.com/inite-ai/inite-brain-service/commit/95ec9a47615dc7ec153cbfdf5f08389bfec313cd))
* **ingest:** an external id is not a name, and an identity that already holds is not an error ([#657](https://github.com/inite-ai/inite-brain-service/issues/657)) ([b91b552](https://github.com/inite-ai/inite-brain-service/commit/b91b5524153ba0c4c4e6ef442c593c720c3e6677))
* **ingest:** inflected mentions file under one entity, and a bare scheduled date is not filed a year back ([#620](https://github.com/inite-ai/inite-brain-service/issues/620)) ([25c3848](https://github.com/inite-ai/inite-brain-service/commit/25c3848220db5bb2bcb9d20a2ca75fb7cf441683))
* **ingest:** link a fact to the turn it came from without an unrelated flag ([#590](https://github.com/inite-ai/inite-brain-service/issues/590)) ([3ed9e52](https://github.com/inite-ai/inite-brain-service/commit/3ed9e528e9ab5fa71bd1105d72cfe5a4ffac7410))
* **jobs:** one identity per process, a fencing epoch on every claim, and a shutdown that drains ([#554](https://github.com/inite-ai/inite-brain-service/issues/554)) ([9d60ed4](https://github.com/inite-ai/inite-brain-service/commit/9d60ed4a0204c0b88e0f2db16054d6579b2e5d4b))
* **jobs:** put every replica-unsafe sweep and boot hook under the lease, and make cursor advances forward-only ([#550](https://github.com/inite-ai/inite-brain-service/issues/550)) ([225472f](https://github.com/inite-ai/inite-brain-service/commit/225472fb24c4bdbde127a296058b6c231a80c8d3))
* **jobs:** repair job_run FLEXIBLE drift and stop the reaper hiding its own failure ([#513](https://github.com/inite-ai/inite-brain-service/issues/513)) ([be86472](https://github.com/inite-ai/inite-brain-service/commit/be8647212516e870b45e8980c4e966734d596195))
* **landing:** one refresh per refresh token — concurrent renewals share the rotation, and /api/auth/me stores what it renewed ([#641](https://github.com/inite-ai/inite-brain-service/issues/641)) ([e57752a](https://github.com/inite-ai/inite-brain-service/commit/e57752a047902fcb9fd9331a5701c5a94682b836))
* **landing:** the quickstart was still teaching the old connect flow ([#580](https://github.com/inite-ai/inite-brain-service/issues/580)) ([6b8f107](https://github.com/inite-ai/inite-brain-service/commit/6b8f107eed9ed73039cf89b48c3e442d7a39f82a))
* **landing:** the session renews itself — the refresh token the callback stored is finally used ([#633](https://github.com/inite-ai/inite-brain-service/issues/633)) ([23fc513](https://github.com/inite-ai/inite-brain-service/commit/23fc51374ea48945da2fa64f6b12949a5feffafb))
* **live,vectors:** repair the LIVE channel after an outage, and stop the width repair re-embedding whole tenants ([#558](https://github.com/inite-ai/inite-brain-service/issues/558)) ([e82ea54](https://github.com/inite-ai/inite-brain-service/commit/e82ea54aa38afe67c69e136934a64be0062f74f2))
* **monitoring:** make alert rules actually load, and make "never worked" visible ([#515](https://github.com/inite-ai/inite-brain-service/issues/515)) ([0683fb5](https://github.com/inite-ai/inite-brain-service/commit/0683fb58260d4fc8b0de22ce9c34d10184332a17))
* **onboarding:** make the connect path tell the truth (wave 0) ([#560](https://github.com/inite-ai/inite-brain-service/issues/560)) ([6ba82e9](https://github.com/inite-ai/inite-brain-service/commit/6ba82e92a9604a5374ee1d41cf313107be219901))
* **ops:** edge liveness on /health, a runbook that matches the code, and the probe on by default ([#522](https://github.com/inite-ai/inite-brain-service/issues/522)) ([6fe2f87](https://github.com/inite-ai/inite-brain-service/commit/6fe2f87ce7b90f502520bd33b33ea87793da067c))
* **reads:** open the per-user read fence by default ([#594](https://github.com/inite-ai/inite-brain-service/issues/594)) ([ac1a6a9](https://github.com/inite-ai/inite-brain-service/commit/ac1a6a9e56a2cdf159f87e3e96e1fc81ae8656d6))
* **registry:** one attribute, one predicate — consolidate the coined vocabulary and close the belief slots it merges ([#602](https://github.com/inite-ai/inite-brain-service/issues/602)) ([90d0240](https://github.com/inite-ai/inite-brain-service/commit/90d024099d35920a38fbc13af29b786c43c1e8e0))
* **replicas:** make the calibration map, admin artifacts and admin streams replica-coherent ([#553](https://github.com/inite-ai/inite-brain-service/issues/553)) ([f3efe16](https://github.com/inite-ai/inite-brain-service/commit/f3efe1603bc054072e08b3ede30f47879ad60216))
* **review:** seven integrity defects — belief CAS watermark, conditional promotion, active-pack consent, answer_cache erasure, dedupe hop ([#557](https://github.com/inite-ai/inite-brain-service/issues/557)) ([c832798](https://github.com/inite-ai/inite-brain-service/commit/c8327985ca72e22c97ec5f5253157b16b2883e1c))
* **router:** move the NLI intent model to a public repo, back off failed warmups, and show them as degraded ([#546](https://github.com/inite-ai/inite-brain-service/issues/546)) ([c6bd4f4](https://github.com/inite-ai/inite-brain-service/commit/c6bd4f4db0be8953722054e444659eea475dff60))
* **runtime:** close session recovery and embedding readiness gaps ([#504](https://github.com/inite-ai/inite-brain-service/issues/504)) ([b2663a9](https://github.com/inite-ai/inite-brain-service/commit/b2663a9fe70b571eb1250742df3f9abd0a0c2cf1))
* **scenes:** make the backlink re-run reconcile pointers instead of unioning them ([#547](https://github.com/inite-ai/inite-brain-service/issues/547)) ([e0c5854](https://github.com/inite-ai/inite-brain-service/commit/e0c585410bf1f1e4f5c25adfb05bd277e9a607b2))
* **search:** detect a missing HNSW index instead of waiting for an error that never comes ([#506](https://github.com/inite-ai/inite-brain-service/issues/506)) ([02204a0](https://github.com/inite-ai/inite-brain-service/commit/02204a0d49f6230708dd4ba1784a98ed7537dbab))
* **search:** remember a tenant's missing HNSW index instead of rediscovering it on every query ([#525](https://github.com/inite-ai/inite-brain-service/issues/525)) ([9052981](https://github.com/inite-ai/inite-brain-service/commit/9052981af48af5f3f437fc69b0ead378a36779f4))
* **serving,extraction:** the history suffix and grounding quotes reach the generator again; the extractor decides a coined predicate's cardinality; relations enter the memory and close through supersedes; a relation answer is cached ([#632](https://github.com/inite-ai/inite-brain-service/issues/632)) ([4788a7b](https://github.com/inite-ai/inite-brain-service/commit/4788a7be0e5ae7a731f29f40c4be5db17d775226))
* **synthesize:** give the L3 degrade path window centers from every anchor source ([#545](https://github.com/inite-ai/inite-brain-service/issues/545)) ([cb155c5](https://github.com/inite-ai/inite-brain-service/commit/cb155c5f7ce566625897dc3f6c52d657b9f2fcdc))
* **synthesize:** relation lines carry no bracket, and the plausibility veto comes off the shipped assembly ([#615](https://github.com/inite-ai/inite-brain-service/issues/615)) ([7f83160](https://github.com/inite-ai/inite-brain-service/commit/7f83160b163c4b66ab882ca5d049a0d31e1bacba))
* **synthesize:** the generator cites short handles, and the id comes back in code ([#613](https://github.com/inite-ai/inite-brain-service/issues/613)) ([19714cc](https://github.com/inite-ai/inite-brain-service/commit/19714cc8f574fe67b05eeb864bc2e057fd870f8e))
* **synthesize:** the verifier accepts arithmetic on the evidence — a percentage of a stated amount is not a new claim ([#629](https://github.com/inite-ai/inite-brain-service/issues/629)) ([bb38d0a](https://github.com/inite-ai/inite-brain-service/commit/bb38d0a4ddea28fb5d492546d2da461f43352490))
* **synthesize:** the verifier knows the evidence is the current state — "currently" on a shown fact is not a claim ([#637](https://github.com/inite-ai/inite-brain-service/issues/637)) ([ceb6141](https://github.com/inite-ai/inite-brain-service/commit/ceb6141b6c35590cc72438433d99a7535d598753))
* **synthesize:** the verifier reads a transition fact as the state it produced — "moved_to: Braga" supports "lives in Braga" ([#649](https://github.com/inite-ai/inite-brain-service/issues/649)) ([65742fe](https://github.com/inite-ai/inite-brain-service/commit/65742fe1990072273c9875afe74b7df4b2bec0f0))
* **synthesize:** time arbitrates between the belief plane and the fact plane — a fact dated after a belief's revision outdates the belief, which leaves the prompt instead of demoting the newer fact ([#646](https://github.com/inite-ai/inite-brain-service/issues/646)) ([6983e85](https://github.com/inite-ai/inite-brain-service/commit/6983e85f1ce885f758d7eff98dd2b50c0fef9946))
* **telemetry:** record the decisions a default deployment actually makes ([#591](https://github.com/inite-ai/inite-brain-service/issues/591)) ([383c66a](https://github.com/inite-ai/inite-brain-service/commit/383c66a26635988c575f2da01624633ec8e80242))
* **vectors:** build only the HNSW indexes a query consumes, and let the segment leg ride its index ([#542](https://github.com/inite-ai/inite-brain-service/issues/542)) ([8a2d036](https://github.com/inite-ai/inite-brain-service/commit/8a2d036d23c2ccc3ed5cf4794d70feb0754b8311))
* **vectors:** retry a boot-deferred corpus repair as soon as the embedder is warm ([#543](https://github.com/inite-ai/inite-brain-service/issues/543)) ([2d393d2](https://github.com/inite-ai/inite-brain-service/commit/2d393d21757dacb7ddef807e23f32270714489e0))
* **vectors:** width-gate every cosine scan, census the corpus, and repair it on boot and nightly ([#540](https://github.com/inite-ai/inite-brain-service/issues/540)) ([36af90e](https://github.com/inite-ai/inite-brain-service/commit/36af90e230862626d9db65d3cf7058a1b1321b01))


### Performance Improvements

* **ci:** stop ts-jest typechecking what tsc already typechecked, and keep its cache ([#519](https://github.com/inite-ai/inite-brain-service/issues/519)) ([59308e1](https://github.com/inite-ai/inite-brain-service/commit/59308e1406861fcde3be631940d32b00122c1310))
* **search:** the entity cross-encoder pass runs only when its order decides something ([#635](https://github.com/inite-ai/inite-brain-service/issues/635)) ([be3324a](https://github.com/inite-ai/inite-brain-service/commit/be3324a87a936a96b66d8fd18d428d0475f62ec8))
* **serving:** the answer path stops paying for work it throws away — cross-encoder inside its budget, probes and passes side by side, the embedder off the event loop ([#625](https://github.com/inite-ai/inite-brain-service/issues/625)) ([6bf5fe2](https://github.com/inite-ai/inite-brain-service/commit/6bf5fe213ce713f09566082aeea65ee82826c6aa))

## [2.2.0](https://github.com/inite-ai/inite-brain-service/compare/v2.1.0...v2.2.0) (2026-09-07)
...
* **beliefs:** wire BELIEFS_FACT_DAMPING — demote fact lines contradicted by current beliefs ([#440](https://github.com/inite-ai/inite-brain-service/issues/440)) ([ec5cb00](https://github.com/inite-ai/inite-brain-service/commit/ec5cb002f834988597510ae812b43cf805ed745b))
...
* **deploy:** enable answer conditioning in prod — broad-question coverage ([#439](https://github.com/inite-ai/inite-brain-service/issues/439)) ([9dc0e02](https://github.com/inite-ai/inite-brain-service/commit/9dc0e0294ca0ba1825d2c6a871b6f81bdfce6cbb))
* **deploy:** enable literal-harvest and belief-transition flags in prod ([#427](https://github.com/inite-ai/inite-brain-service/issues/427)) ([376d50a](https://github.com/inite-ai/inite-brain-service/commit/376d50a2d87195e4ec037662ec1dec4648f59461))
...
* **deploy:** enable mention-path conflict formation + transition classifier in prod ([#447](https://github.com/inite-ai/inite-brain-service/issues/447)) ([e93e7ac](https://github.com/inite-ai/inite-brain-service/commit/e93e7ac5f2df7c29cba2a8f2d6b0ebc709057562))
* **deploy:** enable state-verb harvest in prod; clarify scene-traces catalog default ([#436](https://github.com/inite-ai/inite-brain-service/issues/436)) ([b196826](https://github.com/inite-ai/inite-brain-service/commit/b1968260add064c57455071d230fc01f45a75b12))
* **deploy:** enable the s07/k07 root-cause wave in prod ([#458](https://github.com/inite-ai/inite-brain-service/issues/458)) ([032ecdc](https://github.com/inite-ai/inite-brain-service/commit/032ecdc36f952262453d2727e0c2cd04a92abf6a))
* **deploy:** enable the temporal tiebreaker in prod ([#466](https://github.com/inite-ai/inite-brain-service/issues/466)) ([0f59f31](https://github.com/inite-ai/inite-brain-service/commit/0f59f31d1cb3c21184d9f22352b21a2d6dc1ca40))
...
* **eval:** code-memory battery — coding-agent corpus with pack vocab, transitions and serving checks ([#441](https://github.com/inite-ai/inite-brain-service/issues/441)) ([5476f77](https://github.com/inite-ai/inite-brain-service/commit/5476f775cf3eccb5b5eb801a9578d227c0d06f89))
* **eval:** domain-pack battery — install→vocab→trace chain with multi-domain tracing ([#434](https://github.com/inite-ai/inite-brain-service/issues/434)) ([c26b89c](https://github.com/inite-ai/inite-brain-service/commit/c26b89cb0232a5d912a1c158714d7c39185c9388))
...
* **eval:** state-transition eval battery — mechanical mutable-world-state checks ([#425](https://github.com/inite-ai/inite-brain-service/issues/425)) ([2d23275](https://github.com/inite-ai/inite-brain-service/commit/2d23275e5a889ab22a936024877e8f69f665b5be))
* **eval:** variation axis for the state-transitions battery — paraphrase and RU corpora ([#463](https://github.com/inite-ai/inite-brain-service/issues/463)) ([98416e0](https://github.com/inite-ai/inite-brain-service/commit/98416e077bcadded62423eaa511aade49469dedd))
...
* **extraction:** deterministic literal-harvest lane (EXTRACTOR_LITERAL_HARVEST, default off) ([#423](https://github.com/inite-ai/inite-brain-service/issues/423)) ([ed676dc](https://github.com/inite-ai/inite-brain-service/commit/ed676dc979e9a27998a6d686a657f59105131dea))
* **extraction:** deterministic state-verb harvest lane (EXTRACTOR_STATE_VERB_HARVEST) ([#429](https://github.com/inite-ai/inite-brain-service/issues/429)) ([108e6f3](https://github.com/inite-ai/inite-brain-service/commit/108e6f32062a605575ce4992d785e0547a673879))
* **extraction:** language-agnostic transition classifier (module only, not wired) ([#430](https://github.com/inite-ai/inite-brain-service/issues/430)) ([416a1cc](https://github.com/inite-ai/inite-brain-service/commit/416a1ccbf3585b3f43714dfa10377f06dc96454d))
* **extractor:** coding-domain verbs in the state-verb harvest lexicon ([#437](https://github.com/inite-ai/inite-brain-service/issues/437)) ([05da2dc](https://github.com/inite-ai/inite-brain-service/commit/05da2dc62a3506ae389e6c3b4db7f0a0073e325a))
* **extractor:** wire the transition classifier behind EXTRACTOR_TRANSITION_CLASSIFIER ([#446](https://github.com/inite-ai/inite-brain-service/issues/446)) ([f12ffde](https://github.com/inite-ai/inite-brain-service/commit/f12ffde42ff414a5d4507caf68f4a162835f19ae))
* **facts:** deterministic status landing for calendar-anchored artifact lifecycle claims ([#464](https://github.com/inite-ai/inite-brain-service/issues/464)) ([995468c](https://github.com/inite-ai/inite-brain-service/commit/995468c56bb807f00ad97d4c2e763b77a6e08d44))
* **facts:** mention-path conflict formation — competing pairs for extracted contradictions ([#444](https://github.com/inite-ai/inite-brain-service/issues/444)) ([3e8622d](https://github.com/inite-ai/inite-brain-service/commit/3e8622daa249d7b640934a2013139954af66ff3f))
* **facts:** slot canonicalization — cross-predicate contradictions meet in one slot ([#450](https://github.com/inite-ai/inite-brain-service/issues/450)) ([036ddfc](https://github.com/inite-ai/inite-brain-service/commit/036ddfce1e7b6cd68ecef31cc9708857faaf2261))
...
* **ingest:** alias-aware entity resolution for code identifiers ([#453](https://github.com/inite-ai/inite-brain-service/issues/453)) ([1bd8b2e](https://github.com/inite-ai/inite-brain-service/commit/1bd8b2e570f410e53274fef1c89672e3dc74c8dc))
* **ingest:** article-insensitive entity reuse — one referent, one entity ([#454](https://github.com/inite-ai/inite-brain-service/issues/454)) ([bd8ee7d](https://github.com/inite-ai/inite-brain-service/commit/bd8ee7db39aa8114fafbb8bd9eb60a642e32164b))
* **ingest:** confidence-gate the write-side language stamp ([#460](https://github.com/inite-ai/inite-brain-service/issues/460)) ([abda38e](https://github.com/inite-ai/inite-brain-service/commit/abda38e856e392933fc153ff547efcf474a810d6))
* **ingest:** humanized predicate names in fact index text ([#451](https://github.com/inite-ai/inite-brain-service/issues/451)) ([1acce24](https://github.com/inite-ai/inite-brain-service/commit/1acce24a970a7cd7a1ea8b5cedbd5c39085e45c4))
...
* **packs:** builtin memoryModel visibility — reader unions BUILTIN_PACKS declarations ([#442](https://github.com/inite-ai/inite-brain-service/issues/442)) ([59ee1ee](https://github.com/inite-ai/inite-brain-service/commit/59ee1ee2631fc88249d6c0cc31ccbb309debf02a))
* **packs:** code_memory 0.4.0 — extractionProfile, ontology, memoryModel, eval fixtures ([#443](https://github.com/inite-ai/inite-brain-service/issues/443)) ([d9f9cdb](https://github.com/inite-ai/inite-brain-service/commit/d9f9cdbc50fd2fb3ea96c209083ea1fc214eb543))
* **packs:** industry packs 0.2.0 — memoryModel, eval fixtures for all six domains ([#452](https://github.com/inite-ai/inite-brain-service/issues/452)) ([b0d1ec9](https://github.com/inite-ai/inite-brain-service/commit/b0d1ec9c8d55dd3125c1bdc023de5525c35d6d71))
...
* **beliefs:** belief promotion misses state transitions — negation deltas + field fold ([#135](https://github.com/inite-ai/inite-brain-service/issues/135)) ([#426](https://github.com/inite-ai/inite-brain-service/issues/426)) ([49f205e](https://github.com/inite-ai/inite-brain-service/commit/49f205eb36bf61ca23a334dbffa425ab58f7c7dc))
...
* **beliefs:** supersede foldable-field orphan beliefs on promotion ([#438](https://github.com/inite-ai/inite-brain-service/issues/438)) ([c6bbdc4](https://github.com/inite-ai/inite-brain-service/commit/c6bbdc4704b963b9585d70819b833e21dca5523f))
...
* **deploy:** route /registry to the backend — public pack catalog was a prod 404 ([#433](https://github.com/inite-ai/inite-brain-service/issues/433)) ([c61d427](https://github.com/inite-ai/inite-brain-service/commit/c61d427b9d2691adc16a90df6e131a26b4c6f9be))
* **eval:** k10 measures identity — predicate-agnostic markers + invariant slotting fewshot ([#459](https://github.com/inite-ai/inite-brain-service/issues/459)) ([40b45f7](https://github.com/inite-ai/inite-brain-service/commit/40b45f787a7d025941575d173425558996cdc79f))
...
* **eval:** s05 accepts third-person ownership phrasing ([#432](https://github.com/inite-ai/inite-brain-service/issues/432)) ([016ff42](https://github.com/inite-ai/inite-brain-service/commit/016ff42f4f8e812afb66c4f06d30337d3f53bcbc))
* **extraction:** state_change binds to the state HOLDER, not the transitioned object ([#431](https://github.com/inite-ai/inite-brain-service/issues/431)) ([330dd6e](https://github.com/inite-ai/inite-brain-service/commit/330dd6e0f5c3a4764af736f4eb1012dfde6269f1))
* **extractor:** deterministic flag-default harvest - k08 flag-transition was an LLM-redraw lottery ([#461](https://github.com/inite-ai/inite-brain-service/issues/461)) ([3b983b0](https://github.com/inite-ai/inite-brain-service/commit/3b983b07a3fafa00b4bde2b356785ead18eac3e1))
* **extractor:** rate-limit phrasing in literal harvest + ownership fewshot for code_memory ([#445](https://github.com/inite-ai/inite-brain-service/issues/445)) ([7120205](https://github.com/inite-ai/inite-brain-service/commit/71202053dc77e6039e3d07dd865447077b38538c))
* **extractor:** run harvest lanes on no-entity and replay-skip turns ([#449](https://github.com/inite-ai/inite-brain-service/issues/449)) ([7e5e5bd](https://github.com/inite-ai/inite-brain-service/commit/7e5e5bdeb8e64802476715bc3205a5cbc26e689b))
* **facts:** open the cosine gate for promoted single_active mention slots ([#455](https://github.com/inite-ai/inite-brain-service/issues/455)) ([ba169ba](https://github.com/inite-ai/inite-brain-service/commit/ba169baa0e3718aa703d556c323253f2e1ddc580))
...
* **facts:** temporal tiebreaker — updates supersede, contradictions compete ([#465](https://github.com/inite-ai/inite-brain-service/issues/465)) ([27e1fef](https://github.com/inite-ai/inite-brain-service/commit/27e1fef3374cfd917d8056f3a56e1001831b815c))
...
* **ingest:** user-scoped mentions through the document route ([#462](https://github.com/inite-ai/inite-brain-service/issues/462)) ([eba257f](https://github.com/inite-ai/inite-brain-service/commit/eba257fb651a05027037df61bbf4e447cdc9842d))
...
* **search:** confidence-gate the hard lang filter (k07) + hermetic code-memory k10 corpus ([#456](https://github.com/inite-ai/inite-brain-service/issues/456)) ([e072a61](https://github.com/inite-ai/inite-brain-service/commit/e072a61141a980d92ddeae3fde3bba941866e692))
* **seo:** route catalogue equity to the parent, and unstick server.json version ([#424](https://github.com/inite-ai/inite-brain-service/issues/424)) ([f17f340](https://github.com/inite-ai/inite-brain-service/commit/f17f340bdcdb70560870f6e704f82747ed2c3190))
