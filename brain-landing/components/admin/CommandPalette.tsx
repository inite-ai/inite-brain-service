...
export function CommandPalette({ lang }: { lang: string }) {
  ...
  const entries: PaletteEntry[] = [
    ...
    },
    {
      id: 'policies',
      label: 'Policies',
      hint: 'ABAC · allow/deny rules per key',
      icon: ShieldCheck,
      path: `/${lang}/admin/policies`,
      keywords: ['abac', 'rbac', 'acl', 'access', 'policy'],
    },
    {
      id: 'key-lens',
      label: 'Key Lens',
      hint: 'simulate what a key can see & call',
      icon: ScanEye,
      path: `/${lang}/admin/key-lens`,
      keywords: ['abac', 'simulate', 'simulation', 'lens'],
    },
    {
      id: 'decisions',
      label: 'Decisions',
      hint: 'policy_decision stream · report-only',
      icon: Scale,
      path: `/${lang}/admin/decisions`,
      keywords: ['abac', 'deny', 'would_deny', 'audit'],
    },
    {
      id: 'maintenance',
      label: 'Maintenance',
    ...
    },
    {
      id: 'config',
      label: 'Config',
      hint: 'env knobs catalogue',
      icon: Settings2,
      path: `/${lang}/admin/config`,
      keywords: ['env', 'feature flag', 'toggle'],
    },
    {
      id: 'dlq',
      label: 'Dead-letter',
      hint: 'rejected ingest payloads',
      icon: Trash2,
      path: `/${lang}/admin/dlq`,
    },
    {
      id: 'forgotten',
      label: 'Forgotten',
      hint: 'GDPR proof-of-erasure',
      icon: Skull,
      path: `/${lang}/admin/forgotten`,
      keywords: ['gdpr', 'erasure', 'forget'],
    },
    {
      id: 'pii',
      label: 'PII inventory',
      hint: 'predicates × tenant × count',
      icon: ShieldAlert,
      path: `/${lang}/admin/pii`,
    },
    {
      ...
      hint: 'admin HTTP call log',
      icon: KeyRound,
      path: `/${lang}/admin/operator-actions`,
      keywords: ['audit', 'who did what'],
    },
    {
      id: 'packs',
      label: 'Packs',
      hint: 'install · eval · uninstall',
      icon: Package,
    ...
    },
    {
      id: 'marketplace',
      label: 'Marketplace',
      hint: 'registry · featured · pricing · publishers',
      icon: Store,
      path: `/${lang}/admin/marketplace`,
      keywords: [
        'registry',
        'marketplace',
        'pricing',
    ...
    },
    {
      id: 'sources',
      label: 'Sources',
      hint: 'declared identity · trust reputation',
      icon: Fingerprint,
      path: `/${lang}/admin/sources`,
      keywords: ['sources', 'trust', 'reputation', 'authority', 'authLevel'],
    },
  ]
